...
- New editorial operational entries published: **8**
- PUBLISHED entries: **63**
...
- Historical published audit entries remain `RECONSTRUCTED_FROM_PRODUCTION`,
  not `VALIDATE PASS`; all eight new divorce articles have explicit
...
The relationship-assessment article was also absent from committed historical
planning artifacts and was added as a new editorial operational entry:

- Article ID: `ART_new_20260812_kak-ponyat-chto-pora-razvoditsya`
- Status: `PUBLISHED`
- Frequency: `UNVERIFIED`; no committed verified frequency source exists.
- Hub: pending; no new divorce/relationships Topic Hub was created.
- Practice: `Развод: ясность и спокойствие`, `DIRECT`; canonical public URL
  `https://audiolad.ru/practice/sergey-and-zoya/razvod-yasnost-i-spokoystvie`.
- Production smoke: `VALIDATE PASS` on release
  `20260812-151428-e03cb5f8` (BUILD_ID `RZt-0x07O8JY2RXnEmlHx`).

The child-conversation article was also absent from committed historical
planning artifacts and was added as a new editorial operational entry:

- Article ID: `ART_new_20260812_kak-skazat-rebenku-o-razvode-roditeley`
- Status: `PUBLISHED`
- Frequency: `UNVERIFIED`; no committed verified frequency source exists.
- Hub: pending; no new divorce/relationships Topic Hub was created.
- Practice: `Развод: ясность и спокойствие`, `STRONG`; canonical public URL
  `https://audiolad.ru/practice/sergey-and-zoya/razvod-yasnost-i-spokoystvie`.
- Production smoke: `VALIDATE PASS` on release
  `20260812-154151-305bf1ba` (BUILD_ID `jaUJ4QZX5U4zMQgdVbPpk`).

The child-support article was also absent from committed historical
planning artifacts and was added as a new editorial operational entry:

- Article ID: `ART_new_20260812_kak-pomoch-rebenku-perezhit-razvod-roditeley`
- Status: `PUBLISHED`
- Frequency: `UNVERIFIED`; no committed verified frequency source exists.
- Hub: pending; no new divorce/relationships Topic Hub was created.
- Practice: `Развод: ясность и спокойствие`, `STRONG`; canonical public URL
  `https://audiolad.ru/practice/sergey-and-zoya/razvod-yasnost-i-spokoystvie`.
- Production smoke: `VALIDATE PASS` on release
  `20260812-161916-a7dd95af` (BUILD_ID `Tp9Kjg1e39dnncmLNc6XJ`).

The life-after-divorce article was also absent from committed historical
planning artifacts and was added as a new editorial operational entry:

- Article ID: `ART_new_20260813_zhizn-posle-razvoda`
- Status: `PUBLISHED`
- Frequency: `UNVERIFIED`; no committed verified frequency source exists.
- Hub: pending; no new divorce/relationships Topic Hub was created.
...
The husband-focused divorce recovery article was also absent from committed
historical planning artifacts and was added as a new editorial operational entry:

- Article ID: `ART_new_20260813_kak-perezhit-razvod-s-muzhem`
- Status: `PUBLISHED`
- Frequency: `UNVERIFIED`; no committed verified frequency source exists.
- Hub: pending; no new divorce/relationships Topic Hub was created.
- Practice: `Возвращение к себе после развода`, `DIRECT`; canonical public URL
  `https://audiolad.ru/practice/sergey-and-zoya/vozvraschenie-k-sebe-posle-razvoda`.
- Production smoke: `VALIDATE PASS` on release
  `20260813-055443-b6afb242` (BUILD_ID `ZYPyMtleTCnr-Voaca28r`).
