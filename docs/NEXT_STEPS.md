...
## 0. Плейлисты — PR3 (приоритет: высокий)

PR1 migration применена к production. PR2 CRUD развёрнут (`c470e23`, release `20260715-200910-c470e23`).

Далее:

1. PR3 — добавление продуктов из Аудиотеки (private entitlement + public content rules).
2. PR4 — страница `/playlists/[id]`, порядок ↑↓, listen одного продукта.
