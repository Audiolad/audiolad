...
Миграции: `20260902120100_practice_catalog_visibility_modes.sql`, `20260902120200_create_practice_order_visibility.sql`, `20260902120300_public_playlist_selected_visibility.sql`, `20260902120400_fix_visibility_allowlist_author_policy.sql` (forward restamp of unapplied `20260830120100`–`20260830120400`; archive `deploy/migration-baseline/catalog-visibility-20260830/`, not live planner versions).
