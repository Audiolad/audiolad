...
- `supabase/migrations/20261007130000_topics_functional_scenarios.sql` — Отдых / Релакс / Работа / Концентрация / Учёба / Творчество / Спорт / Желания
...
«Учёба» (`study`) и «Обучение» (`learning`) — разные темы: «Обучение» описывает обучающий контент, а «Учёба» — сценарий прослушивания во время занятий. «Желания» (`desires`) — только множественная форма для практик о намерении, визуализации и исполнении желаний.
...
- Активные хабы: «Любовь к себе»; «Женская энергия»; «Бесплатные медитации»; «Медитации на деньги» и «Изобилие» (`topicKey=money` + разные allowlist, chips off).
...
- Расширение реестра SEO-хабов (энергия, сон, …)
