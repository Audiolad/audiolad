...
| 20260715160000 | archive_demo_catalog_practices | data | Existing demo slugs stay `archived` | `20260715170000` **republishes the three starters** (`published`, unlisted). Starters must **not** be required archived. Probe the five remaining slugs only. |
