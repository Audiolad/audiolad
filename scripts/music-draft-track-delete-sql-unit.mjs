...
const migrationName = "20261126121000_music_draft_track_teardown.sql";
...
assert(versions.includes("20261126121000"), "teardown version listed");
assert(versions.includes("20261126120000"), "kept cyrillic sibling version listed");
