...
assert.deepEqual(
  ...
  [
    "Можно ли выкладывать музыку из Suno на Spotify?",
    "Можно ли выкладывать музыку из Suno на YouTube?",
    "Можно ли продавать музыку из Suno?",
    "Куда лучше загрузить музыку из Suno новичку?",
    "Можно ли одну композицию выложить сразу на несколько площадок?",
    "Можно ли монетизировать трек, созданный на бесплатном Suno?",
  ],
);
...
for (const [number, caption] of [
  ...
  [
    "2",
    "Куда публиковать музыку из Suno зависит от цели: прослушивания, продажи, лицензирование, продвижение или работа с бизнесом.",
  ],
  [
    "3",
    "Перед тем как выкладывать музыку из Suno, проверьте права, исходники и правила выбранной площадки.",
  ],
  [
    "4",
...
for (const value of [
  "Сначала проверьте, можно ли коммерчески использовать музыку из Suno",
  ...
  "Где лучше публиковать музыку из Suno",
  "Как выложить музыку из Suno: короткий маршрут",
  "Нужно ли указывать, что музыка создана в Suno",
  "Можно ли выложить музыку из Suno бесплатно",
