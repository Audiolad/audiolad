...
function testRepoOneFileOneVersion() {
  ...
  assert.equal(
    listed.files.some(
      (row) =>
        row.filename === "20261126120000_music_draft_track_teardown.sql",
    ),
    false,
    "music draft teardown must leave the collided 120000 stamp",
  );
  assert.ok(
    listed.files.some(
      (row) =>
        row.filename === "20261126121000_music_draft_track_teardown.sql",
    ),
  );
}
...
function testProductionLikePendingAfterQuickOffersRestamp() {
  ...
  assert.deepEqual(plan.pending, [
    ...
    "20261009120400",
    "20261009120500",
    "20261019120000", "20261019120100", "20261020120000", "20261021120000", "20261022120000", "20261023120000", "20261024120000", "20261025120000", "20261026120000", "20261026120100", "20261027120000", "20261027120100", "20261028120000", "20261029120000", "20261030120000", "20261031120000", "20261031120200", "20261101120000", "20261102120000", "20261103120000", "20261103120100", "20261103120200", "20261104120000", "20261125120000", "20261126120000", "20261126121000",
  ]);
  assert.equal(plan.database_migrations_pending, 136);
}
...
function testProductionLikePendingAfterPlaylistRestamp() {
  ...
  assert.equal(plan.database_migrations_pending, 130);
}
...
function testOrdinaryDeployAfterLatestMainHasNoHole() {
  ...
  assert.equal(plan.database_migrations_pending, 121);
}
...
function testPostWavProductionPendingMigrationsApply() {
  ...
  assert.equal(plan.database_migrations_pending, 44);
...
function testCurrentProductionAfterMusicPublishPlayable() {
  ...
  assert.deepEqual(plan.pending, ["20261007190000", "20261008120000", "20261008120100", "20261008120200", "20261009120000", "20261009120100", "20261009120200", "20261009120300", "20261009120400",
    "20261009120500", "20261019120000", "20261019120100", "20261020120000", "20261021120000", "20261022120000", "20261023120000", "20261024120000", "20261025120000", "20261026120000", "20261026120100", "20261027120000", "20261027120100", "20261028120000", "20261029120000", "20261030120000", "20261031120000", "20261031120200", "20261101120000", "20261102120000", "20261103120000", "20261103120100", "20261103120200", "20261104120000", "20261125120000", "20261126120000", "20261126121000"]);
  assert.equal(plan.database_migrations_pending, 36);
  assert.equal(plan.action, "apply");
  assert.equal(plan.code, "apply");
}
