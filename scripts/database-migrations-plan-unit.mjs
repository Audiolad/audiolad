...
function testRepoOneFileOneVersion() {
  ...
  assert.ok(
    listed.files.some(
      (row) =>
        row.filename === "20260920120000_practice_listen_stats.sql",
    ),
  );
  assert.ok(
    listed.files.some(
      (row) => row.filename === "20260921120000_practice_ratings.sql",
    ),
  );
  assert.ok(
    listed.files.some(
  ...
  assert.ok(
    listed.files.some(
      (row) =>
        row.filename === "20260923120000_studio_render_job_lease_heartbeat.sql",
    ),
  );
  assert.ok(
    listed.files.some(
      (row) =>
        row.filename === "20260923120100_course_access_levels_foundation.sql",
    ),
  );
  assert.ok(
    listed.files.some(
  ...
  assert.ok(
    listed.files.some(
      (row) =>
        row.filename === "20260928120000_studio_longform_asset_limits.sql",
    ),
  );
  assert.ok(
    listed.files.some(
  ...
  assert.ok(
    listed.files.some(
      (row) =>
        row.filename ===
        "20261002120000_studio_duplicate_project_upload_state_ready.sql",
    ),
  );
  assert.ok(
    listed.files.some(
      (row) =>
        row.filename === "20261003120000_studio_music_entitlements.sql",
    ),
  );
  assert.ok(
    listed.files.some(
      (row) =>
        row.filename === "20261003120100_studio_music_license_orders.sql",
    ),
  );
  assert.ok(
    listed.files.some(
  ...
  assert.ok(
    listed.files.some(
      (row) =>
        row.filename ===
        "20261003120700_studio_music_independent_pricing.sql",
    ),
  );
  assert.ok(
    listed.files.some(
  ...
  assert.ok(
    listed.files.some(
      (row) =>
        row.filename === "20261004120200_studio_catalog_render_principal.sql",
    ),
  );
  assert.ok(
    listed.files.some(
  ...
  assert.ok(
    listed.files.some(
      (row) =>
        row.filename ===
        "20261008120000_author_project_capacity_purchase.sql",
    ),
  );
}
...
function testProductionLikePendingAfterQuickOffersRestamp() {
  ...
  assert.deepEqual(plan.pending, [
    ...
    "20261009120400",
    "20261009120500",
    "20261019120000", "20261019120100", "20261020120000", "20261021120000", "20261022120000", "20261023120000", "20261024120000", "20261025120000", "20261026120000", "20261026120100", "20261027120000", "20261027120100", "20261028120000", "20261029120000", "20261030120000", "20261031120000", "20261031120200", "20261101120000", "20261102120000", "20261103120000", "20261103120100", "20261103120200", "20261104120000", "20261108120000", "20261109120100", "20261109120200", "20261109120300", "20261125120000", "20261126120000", "20261126130000", "20261127120000",
  ]);
  assert.equal(plan.database_migrations_pending, 141);
}
...
function testProductionLikePendingAfterPlaylistRestamp() {
  ...
  assert.deepEqual(plan.pending, [
    ...
    "20261009120400",
    "20261009120500",
    "20261019120000", "20261019120100", "20261020120000", "20261021120000", "20261022120000", "20261023120000", "20261024120000", "20261025120000", "20261026120000", "20261026120100", "20261027120000", "20261027120100", "20261028120000", "20261029120000", "20261030120000", "20261031120000", "20261031120200", "20261101120000", "20261102120000", "20261103120000", "20261103120100", "20261103120200", "20261104120000", "20261125120000", "20261126120000", "20261126130000", "20261127120000",
  ]);
  assert.equal(plan.database_migrations_pending, 131);
}
...
function testOrdinaryDeployAfterLatestMainHasNoHole() {
  ...
  assert.equal(plan.database_migrations_pending, 122);
}
...
function testPostWavProductionPendingMigrationsApply() {
  ...
  const pendingVersions = ["20261007120100", "20261007130000", "20261007140000", "20261007140100", "20261007150000", "20261007160000", "20261007170000", "20261007180000",
    ...
    "20261009120500", "20261019120000", "20261019120100", "20261020120000", "20261021120000", "20261022120000", "20261023120000", "20261024120000", "20261025120000", "20261026120000", "20261026120100", "20261027120000", "20261027120100", "20261028120000", "20261029120000", "20261030120000", "20261031120000", "20261031120200", "20261101120000", "20261102120000", "20261103120000", "20261103120100", "20261103120200", "20261104120000", "20261125120000", "20261126120000", "20261126130000", "20261127120000"];
  ...
  assert.ok(listed.versions.includes("20261007150000"));
  assert.ok(listed.versions.includes("20261007160000"));
  assert.ok(listed.versions.includes("20261007170000"));
  assert.ok(listed.versions.includes("20261007180000"));
  assert.ok(listed.versions.includes("20261007190000"));
  assert.ok(listed.versions.includes("20261008120000"));
  assert.ok(listed.versions.includes("20261008120100"));
  assert.ok(listed.versions.includes("20261008120200"));
  assert.ok(listed.versions.includes("20261009120000"));
  assert.ok(listed.versions.includes("20261009120100"));
  ...
  assert.equal(plan.database_migrations_pending, 45);
  assert.ok(plan.pending.every((version) => version > productionMax));
  assert.equal(plan.action, "apply");
  assert.equal(plan.code, "apply");
}

function testCurrentProductionAfterTopicsStudioRepair() {
  const listed = listLocalMigrationFiles(
    join(dirname(fileURLToPath(import.meta.url)), "../supabase/migrations"),
  );
  const productionMax = "20261007130000";
  const plan = planDatabaseMigrations({
    localVersions: listed.versions,
    remoteVersions: listed.versions.filter((version) => version <= productionMax),
  });
...
function testCurrentProductionAfterSlice2() {
  const listed = listLocalMigrationFiles(
    join(dirname(fileURLToPath(import.meta.url)), "../supabase/migrations"),
  );
  const productionMax = "20261007140000";
  const plan = planDatabaseMigrations({
    localVersions: listed.versions,
    remoteVersions: listed.versions.filter((version) => version <= productionMax),
  });
  assert.deepEqual(plan.pending, ["20261007140100", "20261007150000", "20261007160000", "20261007170000", "20261007180000",
    "20261007190000", "20261008120000", "20261008120100", "20261008120200", "20261009120000", "20261009120100", "20261009120200", "20261009120300", "20261009120400",
    "20261009120500", "20261019120000", "20261019120100", "20261020120000", "20261021120000", "20261022120000", "20261023120000", "20261024120000", "20261025120000", "20261026120000", "20261026120100", "20261027120000", "20261027120100", "20261028120000", "20261029120000", "20261030120000", "20261031120000", "20261031120200", "20261101120000", "20261102120000", "20261103120000", "20261103120100", "20261103120200", "20261104120000", "20261125120000", "20261126120000", "20261126130000", "20261127120000"]);
  assert.equal(plan.database_migrations_pending, 42);
  assert.equal(plan.action, "apply");
  assert.equal(plan.code, "apply");
}

function testCurrentProductionAfterStudioFreeMusic() {
  const listed = listLocalMigrationFiles(
    join(dirname(fileURLToPath(import.meta.url)), "../supabase/migrations"),
  );
  const productionMax = "20261007140100";
  const plan = planDatabaseMigrations({
    localVersions: listed.versions,
    remoteVersions: listed.versions.filter((version) => version <= productionMax),
  });
...
function testCurrentProductionAfterMusicDelivery() {
  const listed = listLocalMigrationFiles(
    join(dirname(fileURLToPath(import.meta.url)), "../supabase/migrations"),
  );
  const productionMax = "20261007150000";
  const plan = planDatabaseMigrations({
    localVersions: listed.versions,
    remoteVersions: listed.versions.filter((version) => version <= productionMax),
  });
...
function testCurrentProductionAfterSeoQueryAnalysis() {
  const listed = listLocalMigrationFiles(
    join(dirname(fileURLToPath(import.meta.url)), "../supabase/migrations"),
  );
  const productionMax = "20261007160000";
  const plan = planDatabaseMigrations({
    localVersions: listed.versions,
    remoteVersions: listed.versions.filter((version) => version <= productionMax),
  });
...
function testCurrentProductionAfterSeoQueryAuthorProposals() {
  const listed = listLocalMigrationFiles(
    join(dirname(fileURLToPath(import.meta.url)), "../supabase/migrations"),
  );
  const productionMax = "20261007170000";
  const plan = planDatabaseMigrations({
    localVersions: listed.versions,
    remoteVersions: listed.versions.filter((version) => version <= productionMax),
  });
...
function testCurrentProductionAfterMusicPublishPlayable() {
  const listed = listLocalMigrationFiles(
    join(dirname(fileURLToPath(import.meta.url)), "../supabase/migrations"),
  );
  const productionMax = "20261007180000";
  const plan = planDatabaseMigrations({
    localVersions: listed.versions,
    remoteVersions: listed.versions.filter((version) => version <= productionMax),
  });
...
function testCurrentProductionAfterCatalogSections() {
  const listed = listLocalMigrationFiles(
    join(dirname(fileURLToPath(import.meta.url)), "../supabase/migrations"),
  );
  const productionMax = "20261009120200";
  const plan = planDatabaseMigrations({
    localVersions: listed.versions,
    remoteVersions: listed.versions.filter((version) => version <= productionMax),
  });
  assert.deepEqual(plan.pending, ["20261009120300", "20261009120400",
    "20261009120500", "20261019120000", "20261019120100", "20261020120000", "20261021120000", "20261022120000", "20261023120000", "20261024120000", "20261025120000", "20261026120000", "20261026120100", "20261027120000", "20261027120100", "20261028120000", "20261029120000", "20261030120000", "20261031120000", "20261031120200", "20261101120000", "20261102120000", "20261103120000", "20261103120100", "20261103120200", "20261104120000", "20261125120000", "20261126120000", "20261126130000", "20261127120000"]);
  assert.equal(plan.database_migrations_pending, 30);
  assert.equal(plan.action, "apply");
  assert.equal(plan.code, "apply");
}
...
function testCurrentProductionAfterWavNormalize() {
  const listed = listLocalMigrationFiles(
    join(dirname(fileURLToPath(import.meta.url)), "../supabase/migrations"),
  );
  const productionMax = "20261009120400";
  const plan = planDatabaseMigrations({
    localVersions: listed.versions,
    remoteVersions: listed.versions.filter((version) => version <= productionMax),
  });
  assert.deepEqual(plan.pending, ["20261009120500", "20261019120000", "20261019120100", "20261020120000", "20261021120000", "20261022120000", "20261023120000", "20261024120000", "20261025120000", "20261026120000", "20261026120100", "20261027120000", "20261027120100", "20261028120000", "20261029120000", "20261030120000", "20261031120000", "20261031120200", "20261101120000", "20261102120000", "20261103120000", "20261103120100", "20261103120200", "20261104120000", "20261125120000", "20261126120000", "20261126130000", "20261127120000"]);
  assert.equal(plan.database_migrations_pending, 28);
  assert.equal(plan.action, "apply");
  assert.equal(plan.code, "apply");
}

function testCurrentProductionAfterStudioDisableNewFree() {
  const listed = listLocalMigrationFiles(
    join(dirname(fileURLToPath(import.meta.url)), "../supabase/migrations"),
  );
  const productionMax = "20261009120300";
  const plan = planDatabaseMigrations({
    localVersions: listed.versions,
    remoteVersions: listed.versions.filter((version) => version <= productionMax),
  });
  assert.deepEqual(plan.pending, ["20261009120400",
    "20261009120500", "20261019120000", "20261019120100", "20261020120000", "20261021120000", "20261022120000", "20261023120000", "20261024120000", "20261025120000", "20261026120000", "20261026120100", "20261027120000", "20261027120100", "20261028120000", "20261029120000", "20261030120000", "20261031120000", "20261031120200", "20261101120000", "20261102120000", "20261103120000", "20261103120100", "20261103120200", "20261104120000", "20261125120000", "20261126120000", "20261126130000", "20261127120000"]);
  assert.equal(plan.database_migrations_pending, 29);
  assert.equal(plan.action, "apply");
  assert.equal(plan.code, "apply");
}
...
function main() {
  ...
  testCurrentProductionAfterTopicsStudioRepair();
  testCurrentProductionAfterSlice2();
  testCurrentProductionAfterStudioFreeMusic();
  testCurrentProductionAfterMusicDelivery();
  testCurrentProductionAfterSeoQueryAnalysis();
  testCurrentProductionAfterSeoQueryAuthorProposals();
testCurrentProductionAfterMusicPublishPlayable();
  testCurrentProductionAfterCatalogSections();
  testCurrentProductionAfterStudioDisableNewFree();
  testCurrentProductionAfterWavNormalize();
