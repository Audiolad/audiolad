...
assert.match(worker, /formatStudioRenderWorkerBootLog/);
const releaseHelper = read("src/lib/studio/render/worker-release.ts");
...
assert.match(repository, /authorizeCatalogAssetsForStudioRender/);
assert.doesNotMatch(repository, /CATALOG_MUSIC_RENDER_NOT_AVAILABLE/);
