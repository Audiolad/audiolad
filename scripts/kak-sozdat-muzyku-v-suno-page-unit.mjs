...
for (const caption of [
  "Создание музыки в Суно удобнее воспринимать как последовательность итераций, а не как одну случайную генерацию.",
  "Начинающему удобно сначала почувствовать логику Суно в Simple Mode, а затем переходить к более точной настройке в Custom.",
  "После первой генерации необязательно начинать всё заново – удачный трек можно развивать и редактировать.",
  "Первая задача в Суно – не создать много музыки, а один раз пройти весь путь от идеи до готовой композиции.",
...
assert.deepEqual(KAK_SOZDAT_MUZYKU_V_SUNO_FAQ.map(({ question }) => question), [
  "Можно ли создать музыку в Суно (Suno) бесплатно?",
  "Как создать музыку в Суно без слов?",
  "Можно ли добавить в Суно свой текст песни?",
  "Какую модель Суно выбрать новичку?",
  "Сколько длится музыка, созданная в Суно?",
  "Можно ли скачать музыку из Суно?",
...
const ctaParagraphs = [
  "Когда у вас появится первый удачный трек из Суно, загляните в АудиоЛад. Посмотрите, как оформлены музыкальные продукты, что слушают пользователи и какие возможности есть у авторов музыки.",
