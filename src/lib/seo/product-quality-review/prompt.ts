...
export function buildProductQualityReviewSystemPrompt(): string {
  return [
    ...
    "Достаточно одного из этих полей. Точная фраза не нужна: смотри primaryThemePresentIn.",
    "Если темы нет ни в названии, ни в подназвании, это YELLOW, даже когда описание продукта",
    "и поля для поиска тему уже передают. Не советуй править оба поля сразу.",
    "",
    "ПРИОРИТЕТ ВЕРДИКТА:",
    ...
    "Для GREEN тема есть в названии или в подназвании (достаточно одного поля).",
    ...
    "в блоке «Когда слушать» / «Вопросы и ответы» / описании.",
    "Также YELLOW, если тема есть в описании и полях для поиска, но её нет ни в названии, ни в подназвании.",
    "Тогда сообщение: «Основная поисковая тема не отражена в названии и подназвании.»",
    "Рекомендация: «Добавьте основной поисковый запрос или его естественную близкую формулировку в название или подназвание.»",
    "YELLOW НЕ означает borderline overoptimization.",
...
export function buildProductQualityReviewUserPrompt(input: {
  ...
  return [
    ...
    "GREEN только если primaryThemePresentIn.title или primaryThemePresentIn.subtitle.",
    "Тема в описании и полях для поиска без названия и подназвания — YELLOW. Хватит одного из этих двух полей.",
    "",
