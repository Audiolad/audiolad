...
export const TOPIC_HUB_DEFINITIONS: readonly TopicHubDefinition[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "В каталоге рядом встречаются разные форматы. Квант-медитация – более «медитативный» вход через внимание и образ. Энергопоток – короткая практика настройки состояния. Отдельные платные сеансы и программы глубже разворачивают тему. Практики с акцентом на изобилие как более широкое состояние мы оставляем для будущего хаба «Изобилие», чтобы не смешивать два поисковых входа.",
    ...
    faq: [
      {
        ...
        answer:
          "Медитация на деньги ближе к запросу про деньги, денежный поток и привлечение денег. Практики на изобилие шире – про состояние открытости и процветания в целом. Часть материалов каталога относится к обоим углам; на этой странице собраны практики с денежным акцентом, а хаб «Изобилие» появится отдельно.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Материалы с явным акцентом на изобилие (например, «Ключ к Изобилию», «Активация канала изобилия», «Кодинг Изобилия») мы готовим для отдельного хаба «Изобилие». Пока их можно найти в каталоге по теме «Деньги» или через поиск.",
      },
    ],
    relatedLinks: [
      {
      ...
      },
      {
        href: "/topics/zhenskaya-energiya",
        title: "Женская энергия",
        description: "Рядом по смыслу – женственность и мягкая сила",
      },
      {
        href: "/authors",
        title: "Авторы АудиоЛада",
