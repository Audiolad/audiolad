...
export const TOPIC_HUB_DEFINITIONS: readonly TopicHubDefinition[] = [
  {
    ...
    body: [
      "Любовь к себе в поиске часто формулируют как «принятие себя», «самоценность» или «уверенность». На АудиоЛаде эти запросы собраны вокруг платформенных тем «Уверенность» и «Самооценка»: здесь практики, которые помогают снизить внутреннюю критику и услышать себя спокойнее.",
    ...
    faq: [
      {
        ...
        answer:
          "В поиске это близкие формулировки одного намерения – относиться к себе бережнее. В каталоге АудиоЛада рядом стоят платформенные темы «Уверенность» и «Самооценка», а эта страница собрана под самый частый пользовательский запрос «любовь к себе».",
      },
      {
    ...
    relatedLinks: [
      ...
      },
      {
        ...
        description: "Фильтр каталога по теме «Уверенность»",
      },
      {
  ...
  },
  {
    ...
    body: [
      ...
      "На АудиоЛаде отдельной платформенной темы «женская энергия» пока нет – релевантные опубликованные практики помечены темой «Уверенность» (часто вместе с «Энергия» или «Отношения»). Здесь собрана редакционная подборка именно под женский энергетический угол; страница «Любовь к себе» отвечает на запросы про принятие и самоценность.",
    ],
    faq: [
      {
