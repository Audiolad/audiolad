...
export const KAK_PERESTAT_PEREZHIVAT_IZ_ZA_DENEG_ARTICLE = {
  ...
  afterFinalAudio: [
    ...
    {
      before:
        "Если страх проявляется в конкретных денежных ситуациях – обсуждении цены, просмотре расходов, получении денег или ответственности – отдельно можно прочитать статью ",
      linkLabel:
