...
import { KAK_SOZDAT_SVOYU_MEDITATSIYU_ARTICLE } from "./content/kak-sozdat-svoyu-meditatsiyu";
import { KAK_ZAPISAT_MEDITATSIYU_SAMOSTOYATELNO_ARTICLE } from "./content/kak-zapisat-meditatsiyu-samostoyatelno";
...
import { KAK_NACHINAYUSHCHEMU_PSIKHOLOGU_NAYTI_PERVYKH_KLIENTOV_ARTICLE } from "./content/kak-nachinayushchemu-psikhologu-nayti-pervykh-klientov";
...
import { PRODUKTY_PSIKHOLOGA_ARTICLE } from "./content/produkty-psikhologa";
...
import { PRODVIZHENIE_TAROLOGA_ARTICLE } from "./content/prodvizhenie-tarologa";
import { PRODVIZHENIE_ASTROLOGA_ARTICLE } from "./content/prodvizhenie-astrologa";
...
import { KAK_PRAVILNO_SFORMULIROVAT_ZHELANIE_ARTICLE } from "./content/kak-pravilno-sformulirovat-zhelanie";
import { KAK_ZAMECHAT_VOZMOZHNOSTI_ARTICLE } from "./content/kak-zamechat-vozmozhnosti";
import { OSHCHUSHCHENIE_DOSTATKA_ARTICLE } from "./content/oshchushchenie-dostatka";
...
const ARTICLE_DEFINITIONS = [
  ...
  KAK_SOZDAT_SVOYU_MEDITATSIYU_ARTICLE,
  KAK_ZAPISAT_MEDITATSIYU_SAMOSTOYATELNO_ARTICLE,
  ...
  PRODVIZHENIE_TAROLOGA_ARTICLE,
  PRODVIZHENIE_ASTROLOGA_ARTICLE,
  ...
  KAK_PRAVILNO_SFORMULIROVAT_ZHELANIE_ARTICLE,
  KAK_ZAMECHAT_VOZMOZHNOSTI_ARTICLE,
  OSHCHUSHCHENIE_DOSTATKA_ARTICLE,
  ...
  KAK_UMENSHIT_IMPULSIVNYE_POKUPKI_ARTICLE,
  KAK_POVYSIT_DOHOD_ARTICLE,
