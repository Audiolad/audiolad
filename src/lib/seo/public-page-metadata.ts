...
} from "@/lib/seo/kak-prodat-muzyku-sozdannuyu-ii/content";
import {
...
export function buildKakSozdatMuzykuVSunoMetadata(): Metadata {
  const canonical = buildSiteCanonicalUrl(KAK_SOZDAT_MUZYKU_V_SUNO_PATH);
...
export function buildKakSozdatMuzykuPoTekstuSPomoshchyuIiMetadata(): Metadata {
  const canonical = buildSiteCanonicalUrl(KAK_SOZDAT_MUZYKU_PO_TEKSTU_S_POMOSHCHYU_II_PATH);
...
export function buildKakProdatMuzykuSozdannuyuIiMetadata(): Metadata {
  const canonical = buildSiteCanonicalUrl(KAK_PRODAT_MUZYKU_SOZDANNUYU_II_PATH);

  return {
    title: KAK_PRODAT_MUZYKU_SOZDANNUYU_II_SEO_TITLE,
...
export function buildMozhnoLiZarabotatNaIiMuzykeMetadata(): Metadata {
  const canonical = buildSiteCanonicalUrl(MOZHNO_LI_ZARABOTAT_NA_II_MUZYKE_PATH);
