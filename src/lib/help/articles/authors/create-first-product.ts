  ...
  sections: [
    ...
    },
    {
      ...
      notes: [
        ...
        "Бесплатный продукт можно создать сразу после одобрения авторской заявки и отправить на модерацию без коммерческого статуса.",
        "Коммерческий статус нужен только для платных продуктов — см. статью о коммерческом статусе.",
