...
export function isBottomNavNeutralPathname(pathname: string): boolean {
  ...
  // Editorial SEO articles, help center, about, philosophy and for-authors
  // pages are not primary tabs – keep BottomNav visible without an active item.
  return (
    pathname === "/articles" ||
    ...
    pathname === "/dlya-avtorov-meditatsiy" ||
    ...
    pathname === "/kak-sozdat-muzyku-v-suno" ||
    pathname === "/kak-sozdat-pesnyu-s-pomoshchyu-ii" ||
    ...
    pathname === "/kak-zarabotat-na-muzyke-iz-suno"
  );
}
