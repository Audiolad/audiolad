...
export const AUTHOR_FINANCE_SECTION_SUBTITLE =
  "Начисления, сохранение и выплаты по вашим продуктам";

export const AUTHOR_FINANCE_HOLD_DAYS_LABEL = "Срок до доступности";
export const AUTHOR_FINANCE_NEXT_AVAILABLE_PREFIX = "Станет доступно";

export function formatAuthorFinanceHoldDays(days: number | null): string {
...
export const AUTHOR_FINANCE_KPI_HINTS = {
  accrued: "Все начисления за всё время.",
  held: "Деньги уже ваши, но ещё идёт период сохранения.",
...
> = {
  ...
  terms_missing: {
    ...
    body: "Доля и срок до доступности для начислений пока не заданы платформой. Если продажа уже возможна, напишите в поддержку.",
  },
  no_sales: {
  ...
  held_only: {
    title: "Сохранённые начисления",
    body: "Начисления уже сохранены за вами. После завершения периода сохранения сумма станет доступна к выплате.",
  },
  below_threshold: {
...
export const AUTHOR_FINANCE_METHODOLOGY: ReadonlyArray<{
  ...
  {
    title: "Что такое период сохранения",
    body: "После оплаты начисление какое-то время сохраняется — это срок, в течение которого возможен возврат покупателю. Срок до доступности указан в ваших условиях. Пока идёт период сохранения, деньги уже ваши, но ещё не доступны к выплате.",
  },
  {
  ...
  },
  {
    ...
    body: "Когда период сохранения закончился, сумма становится доступной. Как только доступная сумма достигает 1000 ₽, формируется выплата: эти деньги резервируются и больше не участвуют в расчёте доступного остатка.",
  },
  {
