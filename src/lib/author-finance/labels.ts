...
> = {
  ...
  commercial_onboarding_incomplete: {
    ...
    body: "Когда подключение будет завершено и условия согласованы, начисления и выплаты появятся здесь.",
  },
  access_suspended: {
  ...
  terms_missing: {
    title: "Ждём согласования условий",
    body: "Действующих коммерческих условий пока нет. Начисления начнутся с момента, когда условия вступят в силу.",
  },
  no_sales: {
...
export const AUTHOR_FINANCE_METHODOLOGY: ReadonlyArray<{
...
}> = [
  {
    ...
    body: "С каждой продажи берётся сумма, которую фактически заплатил покупатель, и от неё считается ваша доля по действующим условиям. Копейки округляются вниз в пользу платформы.",
  },
  {
