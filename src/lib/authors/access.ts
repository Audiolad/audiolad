...
export function getAuthorAccessBannerMessage(
  ...
  switch (status) {
    case "free":
      return "Вы можете создавать бесплатные аудиопродукты и отправлять их на модерацию. Коммерческий статус нужен только для продажи платных продуктов.";
    case "commercial_pending":
      return "Заявка на коммерческий статус рассматривается. Бесплатные продукты можно создавать и отправлять на модерацию уже сейчас.";
    case "commercial_onboarding":
...
export function getPaidPricingDisabledReason(
  ...
  // free / commercial_pending — commercial is only for paid products
  return "Коммерческий статус нужен только для продажи. Бесплатный продукт можно создать и отправить на модерацию уже сейчас.";
}
