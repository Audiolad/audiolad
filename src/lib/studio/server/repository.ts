...
export async function downloadStudioProjectAsset(projectId: string, assetId: string) {
  ...
  if (asset.source_type === "catalog" || !asset.storage_path) {
    throw new StudioApiError("not_found", 404);
  }
