...
const ERROR_MESSAGES: Record<string, string> = {
  ...
  invalid_file_type: "Выберите аудиофайл в формате MP3 или M4A.",
  file_too_large: "Размер файла превышает 50 МБ.",
  invalid_file_size: "Файл слишком большой. Проверьте лимит размера.",
  empty_file: "Файл пустой. Выберите другой аудиофайл.",
  invalid_audio_duration: "Не удалось определить длительность аудиофайла.",
