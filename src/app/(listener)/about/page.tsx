...
const NEXT_LINKS = [
  ...
  },
  {
    ...
    description:
      "Найти инструкции для слушателей и авторов или обратиться в поддержку.",
  },
  {
    href: "/for-authors",
    title: "Авторам",
      ...
      <article className="pb-12 pt-4">
        ...
        <Section id="about-why" title="Почему появился АудиоЛад">
          <p>
            ...
            потерять то, что действительно полезно и к чему хочется
            возвращаться.
          </p>
          <p>
        ...
        <Section id="about-audio" title="Почему именно аудио">
          ...
          <p>
            ...
            человек слышит живое звучание и ощущает присутствие автора, а не
            только воспринимает текстовые формулировки.
          </p>
        </Section>
