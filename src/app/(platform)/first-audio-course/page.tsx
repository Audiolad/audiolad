        ...
        <div className="px-5 pb-8 pt-6 lg:px-12 lg:pt-8">
          ...
          <div className="lg:mt-14 lg:grid lg:grid-cols-2 lg:gap-6">
            ...
            <Section title="Что вы узнаете" className={cardClassName}>
              <BulletList
                items={[
                  ...
                  "почему голос автора передаёт смысл, интонацию, состояние и энергетику",
            ...
            <Section title="Как вы получите доступ" className={cardClassName}>
              <p>
                Сразу после оплаты аудиоподкаст станет доступен для
                прослушивания на сайте. Материал можно слушать онлайн в любое
                время – доступ сохраняется без ограничения по сроку.
              </p>
            </Section>
