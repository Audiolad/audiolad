  ...
  return (
    <LegalPageShell>
          ...
          <Section id="section-3" title="3. Какие данные мы обрабатываем">
            ...
            <BulletList
              items={[
                ...
                "текст обращения в поддержку и указанный для ответа контактный email;",
                "технические сведения о работе сайта, необходимые для обеспечения его функционирования.",
              ]}
            />

            <p className={bodyClassName}>
              При обращении через форму поддержки Сайт сохраняет сообщение,
              контактный email и связанные технические сведения (например,
              идентификатор пользователя при авторизации и очищенный адрес
              страницы) исключительно для обработки обращения и ответа на него.
            </p>
          ...
          <Section id="section-8" title="8. Файлы cookie">
            ...
            <p className={bodyClassName}>
              При согласии на аналитические cookies могут использоваться Вебвизор,
              карта кликов и карта скроллинга Яндекс Метрики. Содержимое полей ввода
              (email, пароль, имя, телефон, сообщения и другие персональные данные)
              в записи сессий не сохраняется. Решение можно изменить в разделе
