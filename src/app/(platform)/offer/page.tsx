...
export const metadata: Metadata = {
  ...
  description:
    "Публичная оферта о продаже цифровых аудиопродуктов и предоставлении доступа к авторским аудиоматериалам на сайте «АудиоЛад».",
};
  ...
  return (
    <LegalPageShell>
          ...
          <p className="mt-3 text-[17px] leading-6 text-[#4c3d78] lg:text-[18px]">
            о продаже цифровых аудиопродуктов и предоставлении доступа к
            авторским аудиоматериалам на сайте «АудиоЛад»
          </p>
          ...
          <Section id="section-1" title="1. Общие положения">
            <p className={bodyClassName}>
              ...
              предоставления доступа к ним посредством сайта «АудиоЛад»,
            ...
            <p className={bodyClassName}>
              ...
              аудиоматериалы. Доступ к цифровым аудиопродуктам может быть
              платным или бесплатным. Отдельные цифровые аудиопродукты могут
              иметь стоимость, самостоятельно определяемую Покупателем.
            </p>
          ...
          <Section id="section-2" title="2. Термины">
            ...
            <p className={bodyClassName}>
              <strong className="font-semibold text-[#25135c]">Платформа</strong>{" "}
              – сайт «АудиоЛад», расположенный по адресу{" "}
              <a
                href="https://audiolad.ru"
                className={linkClassName}
                rel="noopener noreferrer"
              ...
              , а также связанные с ним программные, информационные и технические
              сервисы, посредством которых осуществляется продажа цифровых
              аудиопродуктов и предоставление доступа к ним.
            </p>
            ...
            <p className={bodyClassName}>
              <strong className="font-semibold text-[#25135c]">
                Продукт со свободной стоимостью
              </strong>{" "}
              – цифровой аудиопродукт, стоимость которого самостоятельно
            ...
            <p className={bodyClassName}>
              ...
              – оплата Продукта со свободной стоимостью в сумме, самостоятельно
              определённой Покупателем. В пользовательском интерфейсе Сайта
              Свободная оплата может обозначаться как «Поблагодарить автора».
            </p>
          </Section>
          ...
          <Section id="section-3" title="3. Предмет договора">
            <p className={bodyClassName}>
              ...
              Для цифрового аудиопродукта с фиксированной стоимостью Продавец,
              как правило, предоставляет Покупателю доступ после подтверждения
              оплаты. Для Продукта со свободной стоимостью доступ может быть
              предоставлен до оплаты.
            </p>
            ...
            <p className={bodyClassName}>
              ...
              Оплата Продукта со свободной стоимостью является оплатой ранее
              предоставленной информационной услуги (доступа к цифровому
              аудиопродукту), если доступ был предоставлен Покупателю до
              совершения платежа.
            </p>

            <p className={bodyClassName}>
              <strong className="font-semibold text-[#25135c]">3.5.</strong>{" "}
              Совершение Свободной оплаты само по себе не влечёт возникновения у
              Покупателя дополнительных прав, консультаций или материалов сверх
              уже предоставленного доступа к соответствующему цифровому
              аудиопродукту, если иное прямо не указано на Сайте.
            </p>
          </Section>
          ...
          <Section id="section-4" title="4. Оформление заказа">
            ...
            <p className={bodyClassName}>
              <strong className="font-semibold text-[#25135c]">4.4.</strong>{" "}
              Заказ и оплата Продукта со свободной стоимостью могут
              осуществляться после предоставления Покупателю доступа к такому
              продукту.
            </p>
          </Section>
          ...
          <Section id="section-5" title="5. Стоимость и порядок оплаты">
            <p className={bodyClassName}>
              ...
              Стоимость цифрового аудиопродукта может быть фиксированной либо
              самостоятельно определяться Покупателем. Фиксированная стоимость
              указывается на странице соответствующего продукта.
            </p>
            ...
            <p className={bodyClassName}>
              <strong className="font-semibold text-[#25135c]">5.5.</strong> При
              Свободной оплате Покупатель самостоятельно определяет сумму оплаты
              до совершения платежа.
            </p>

            <p className={bodyClassName}>
              <strong className="font-semibold text-[#25135c]">5.6.</strong>{" "}
              Сумма, подтверждённая Покупателем при совершении платежа, является
              согласованной стоимостью соответствующего цифрового
              аудиопродукта.
            </p>

            <p className={bodyClassName}>
              <strong className="font-semibold text-[#25135c]">5.7.</strong>{" "}
              Обозначение «Поблагодарить автора» в пользовательском интерфейсе
              Сайта не является обозначением благотворительного пожертвования.
            </p>
          </Section>
          ...
          <Section id="section-6" title="6. Предоставление доступа">
            ...
            <p className={bodyClassName}>
              ...
              Если иное не указано в описании соответствующего цифрового
              аудиопродукта, доступ к приобретённому цифровому аудиопродукту
              предоставляется на весь срок функционирования Платформы
              «АудиоЛад».
            </p>

            <p className={bodyClassName}>
              <strong className="font-semibold text-[#25135c]">6.4.</strong> В
              случае прекращения деятельности Платформы Продавец вправе
              прекратить предоставление доступа к цифровым аудиопродуктам после
              выполнения обязательных требований законодательства Российской
              Федерации и завершения необходимых процедур по прекращению
              деятельности. По возможности Продавец заранее уведомляет
              Покупателей о таком прекращении.
            </p>
            ...
            <p className={bodyClassName}>
              <strong className="font-semibold text-[#25135c]">6.6.</strong>{" "}
              ...
              использовать способами, нарушающими авторские и иные
              интеллектуальные права авторов, правообладателей или Продавца.
            </p>

            <p className={bodyClassName}>
              <strong className="font-semibold text-[#25135c]">6.7.</strong>{" "}
              Свободная оплата сама по себе не изменяет срок и условия
              предоставленного Покупателю доступа.
            </p>
          </Section>
          ...
          <Section id="section-7" title="7. Авторские права">
            <p className={bodyClassName}>
              ...
              Цифровые аудиопродукты являются объектами авторских и иных
              интеллектуальных прав и охраняются законодательством Российской
              Федерации. Исключительные права на цифровые аудиопродукты
              принадлежат их авторам либо иным правообладателям. Продавец
              использует такие произведения на основании предоставленных ему
              прав, лицензий и иных законных оснований.
            </p>
          ...
          <Section id="studio-license" title="Лицензия для Студии АудиоЛад">
            <p className={bodyClassName}>
              Пользователь, получивший Лицензию для Студии, принимает для
              соответствующей операции условия этого раздела. Продавец
              предоставляет простую неисключительную сублицензию на материал для
              использования в Студии АудиоЛад. Исключительные права и право
              собственности на исходную музыку не передаются.
            </p>
            <p className={bodyClassName}>
              Одна лицензия на альбом или публикацию открывает все её треки и
              позволяет использовать их в нескольких собственных проектах, если
              для продукта не указано иное. Разрешаются воспроизведение,
              нарезка, изменение громкости, затухания, зацикливание, сведение с
              голосом, SFX и другими материалами, техническая и творческая
              обработка, экспорт, распространение, публичное исполнение,
              сообщение для всеобщего сведения, использование вне АудиоЛада,
              коммерческое использование, публикация на цифровых платформах,
              включение в собственные продукты, платный или бесплатный доступ и
              монетизация Результата проекта.
            </p>
            <BulletList
              items={[
                "нельзя продавать, перепродавать, отдельно распространять или скачивать исходную музыку;",
            ...
            />
            <p className={bodyClassName}>
              Территория лицензии – весь мир; срок – срок исключительных прав в
              доступном Автору объёме. Указание автора не требуется, если иное
              не предусмотрено продуктом или законом. Последующее отключение
              повторного использования либо удаление продукта не прекращает
              ранее выданную лицензию.
            </p>
            <p className={bodyClassName}>
              Лицензия может быть прекращена при возврате, chargeback, споре,
              нарушении прав третьих лиц, требовании суда или органа власти,
              нарушении пользователем условий, закона или оферты. Лицензия
              бывает бесплатной или платной.
            </p>
          </Section>
          ...
          <Section id="section-8" title="8. Обновление цифровых аудиопродуктов">
            ...
            <p className={bodyClassName}>
              ...
              Продавец вправе снять цифровой аудиопродукт с продажи, исключить
              его из публичного каталога либо прекратить его дальнейшее
              распространение. Такое решение не влияет на доступ Покупателей,
              которые приобрели данный продукт ранее, за исключением случаев
              прекращения деятельности Платформы либо иных случаев, прямо
