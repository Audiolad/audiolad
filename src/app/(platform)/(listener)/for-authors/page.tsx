    ...
    <>
      ...
      <article className="pb-12 pt-4">
        ...
        <Section id="for-authors-formats" title="Что можно публиковать">
          <p>
            Для медитаций, практик и других голосовых материалов основой должен
            быть живой голос автора. Для музыки голос не обязателен: трек или
            альбом могут быть без речи. В зависимости от формата можно
            публиковать:
          </p>
