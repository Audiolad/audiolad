      ...
      <div className="mx-auto min-h-screen w-full max-w-[430px] bg-platform-surface pb-10 lg:max-w-[820px]">
        <div className="px-5 pb-8 pt-6 lg:px-12 lg:pt-10">
          ...
          <Section id="section-8" title="8. Файлы cookie">
            <p className={bodyClassName}>
              Сайт использует только технически необходимые файлы cookie,
              обеспечивающие корректную работу сайта и авторизацию
              пользователей.
            </p>

            <p className={bodyClassName}>
              На момент публикации настоящей Политики системы веб-аналитики,
              включая Яндекс Метрику, Google Analytics и аналогичные сервисы, на
              сайте не используются.
            </p>

            <p className={bodyClassName}>
              При подключении подобных сервисов настоящая Политика может быть
              обновлена.
            </p>
          </Section>
