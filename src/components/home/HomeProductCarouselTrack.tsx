...
type HomeProductCarouselTrackProps = {
...
/**
 * Horizontal home product scroller — same navigation pattern as
 * CatalogProductCarousel, keeping HomeProductCard.
 */
export default function HomeProductCarouselTrack({
  products,
  prevAriaLabel = "Предыдущие рекомендации",
  nextAriaLabel = "Следующие рекомендации",
}: HomeProductCarouselTrackProps) {
  ...
  return (
    <div className="relative" data-home-product-carousel="true">
      {showArrows ? (
      ...
      <div
        ref={scrollerRef}
        tabIndex={0}
        className="home-carousel-track catalog-carousel mt-3.5 flex gap-3 overflow-x-auto pb-1 xl:mt-4 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#7042c5]"
        onKeyDown={(event) => {
