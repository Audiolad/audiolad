              ...
              {track ? (
                ...
                <div className="grid grid-cols-3 gap-0.5">
                  ...
                  <TrackActionButton label="Удалить и сдвинуть" disabled={!selectedClip} onClick={rippleDeleteSelectedClip}>
                    <svg aria-hidden="true" viewBox="0 0 24 24" className="h-[22px] w-[22px]" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M7 5h10M10 9v5m4-5v5M9 5l1-2h4l1 2M8 5l1 11h6l1-11M20 19H4m0 0 3-3M4 19l3 3" /></svg>
                  </TrackActionButton>
                  <TrackActionButton
