...
export default function MaxAuthorAppreciation({
  authorName,
  authorSlug,
  productSlug,
  ...
  async function submitCheckout() {
    ...
    setPaymentLink(null);
    try {
      const response = await fetch(MAX_APPRECIATION_PATH, {
        method: "POST",
      ...
      if (!response.ok || !isHttpsUrl(link)) {
    ...
    <>
      ...
      >
        ...
        >
          ...
          {APPRECIATION_CTA_LABEL.slice(APPRECIATION_CTA_LABEL.indexOf(APPRECIATION_CTA_HEART) + APPRECIATION_CTA_HEART.length)}
        </button>
