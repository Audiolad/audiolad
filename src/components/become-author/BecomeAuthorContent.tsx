  ...
  return (
    <section className="mt-6 rounded-[28px] border border-[#eadff8] bg-gradient-to-br from-[#fffaff] to-[#f2e6fb] p-5 shadow-[0_12px_30px_rgba(90,60,145,0.08)] lg:p-6">
      ...
      <p className={`mt-3 ${becomeAuthorBodyClass}`}>
        Создавайте аудиопрактики, музыку и программы, находите слушателей и
        развивайте своё авторское направление.
      </p>

      <p className={`mt-3 ${becomeAuthorBodyClass}`}>
        АудиоЛад помогает авторам публиковать голосовые практики и музыку,
      ...
      <section aria-labelledby="become-author-fit-heading">
        ...
        >
          ...
          <ul className="mt-3 list-disc space-y-2 pl-5">
            ...
            <li>музыкант, нейрокомпозитор или создатель ИИ-музыки;</li>
            <li>
            ...
            <li>
              готовы делиться знаниями и опытом через живой голос или публиковать
              музыку без речи;
            </li>
            <li>
      ...
      <section aria-labelledby="become-author-formats-heading">
        ...
        >
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>музыку, музыкальные треки и альбомы;</li>
          ...
          <p className="mt-4 font-medium text-[#7042c5]">
            Для голосовых форматов используется живой голос автора. Для музыки
            голос не обязателен.
          </p>
          <p className={`mt-3 ${becomeAuthorBodyClass}`}>
            Использование ИИ при создании музыки не мешает подать заявку:
            автором остаётся человек, при этом сохраняются требования платформы
            к правам, качеству и модерации.
          </p>
        </div>
      </section>
        ...
        <ol className="mt-4 space-y-4">
          {[
            ...
            },
            {
              ...
              text: "После предварительного одобрения вы сможете оформить авторский профиль и подготовить минимум одну аудиопрактику или музыку в подарок.",
            },
            {
