...
const PLATFORM_TEXT = [
  "АудиоЛад создан не только как площадка для прослушивания, но и как пространство, где авторы могут публиковать свои знания, находить слушателей и постепенно превращать творчество в собственное направление.",
  "Ваши аудиопродукты смогут жить на платформе, помогать людям и продолжать работать на вас после окончания Школы.",
] as const;

const FINAL_ACCENT =
  "Вы завершите обучение не только с готовыми материалами, но и с реальным местом, где сможете продолжать развиваться как автор.";
...
const FEATURES: readonly Feature[] = [
  {
    ...
    text: "У вас появится личная страница на АудиоЛаде, где слушатели смогут познакомиться с вами, вашим подходом и всеми созданными аудиопродуктами.",
    icon: <ProfileIcon />,
  },
  {
    id: "publish",
    title: "Публикация аудиопродуктов",
    text: "Вы сможете размещать медитации, аудиопрактики, программы, аудиокурсы, лекции и другие материалы в удобном формате.",
    icon: <PublishIcon />,
  },
  {
    id: "pricing",
    title: "Бесплатные и платные продукты",
    text: "Вы сможете самостоятельно выбирать, какие аудиопродукты использовать для знакомства с аудиторией, а какие предлагать за оплату.",
    icon: <FreePaidIcon />,
  },
  {
    id: "listeners",
    title: "Первые слушатели",
    text: "Опубликованные продукты смогут находить люди, которым близка ваша тема, голос, методика и внутреннее состояние.",
    icon: <ListenersIcon />,
  },
  {
    id: "promote",
    title: "Продвижение на АудиоЛаде",
    text: "Лучшие аудиопродукты смогут попадать в подборки, рекомендации, тематические разделы и другие точки знакомства с новой аудиторией.",
    icon: <PromoteIcon />,
  },
  {
    id: "income",
    title: "Продажи и доход",
    text: "Платные аудиопродукты смогут приносить вам доход, а слушатели – возвращаться к вашим новым практикам и программам.",
    icon: <IncomeIcon />,
  },
  {
    id: "growth",
    title: "Развитие авторского направления",
    text: "Со временем вы сможете собрать собственную библиотеку аудиопродуктов, расширять линейку, находить новую аудиторию и укреплять своё имя как автора.",
    icon: <GrowthIcon />,
  },
] as const;
        ...
        {FEATURES.map((feature) => (
          <li key={feature.id} className="school-after__feature">
            ...
            <div className="school-after__feature-body">
              ...
              <p className="school-after__feature-text">{feature.text}</p>
            </div>
          </li>
        ))}
      </ul>
