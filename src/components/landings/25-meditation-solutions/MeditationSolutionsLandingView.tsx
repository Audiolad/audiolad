    ...
    >
      ...
      >
        <div
          ...
          className="rounded-[28px] border border-[#e8def5] bg-white px-5 py-5 shadow-[0_12px_32px_rgba(37,19,92,0.07)] sm:px-6 sm:py-6"
        >
          <div
            data-meditation-solutions-hero-cover
            className="relative mx-auto aspect-square w-full max-w-[240px] overflow-hidden rounded-[22px] bg-[#efe6fb] sm:max-w-[280px]"
          >
            <Image
              ...
              fill
              priority
              sizes="(max-width: 430px) 240px, 280px"
