    ...
    <article className="rounded-[24px] border border-[#eadff8] bg-white p-4 shadow-[0_8px_22px_rgba(91,62,145,0.06)]">
      <div className="flex gap-4">
        ...
        <div className="flex min-w-0 flex-1 flex-col">
          <Link
            href={productHref}
            className="line-clamp-2 text-[17px] font-semibold leading-6 text-[#25135c] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#7042c5]"
          >
            {item.title}
          </Link>
