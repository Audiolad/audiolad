...
const primaryCtaClassName = `inline-flex min-h-12 w-full items-center justify-center rounded-[22px] bg-[#7042c5] px-5 py-3 text-center text-[16px] font-medium leading-6 text-white hover:bg-[#6338b0] sm:w-auto sm:px-6 ${linkFocusClass}`;
