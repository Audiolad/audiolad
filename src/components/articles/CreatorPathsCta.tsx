...
function CreatorPathCard({ kind }: CreatorPathCardProps) {
  ...
  const description = isStudio
    ...
    : "Создайте своё авторское пространство, публикуйте медитации, практики, аудиокурсы и зарабатывайте на своём творчестве.";
  const href = isStudio ? STUDIO_HREF : MEDITATION_AUTHORS_LANDING_PROMO_LINK.href;
  const eyebrow = isStudio ? "СТУДИЯ АУДИОЛАД" : "КАБИНЕТ АВТОРА";
  const cta = isStudio
